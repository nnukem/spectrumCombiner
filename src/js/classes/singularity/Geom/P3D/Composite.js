...
export default class Composite extends EventDispatcher {
  	// planes
  	static get XY () { return 'XY' }
  	static get XZ () { return 'XZ' }
  	static get YZ () { return 'YZ' }
...
*/
  ...
  addControlPoint (_xCoord, _yCoord, _zCoord) { throw new Error('Composite::addControlPoint() must be overriden') }

  moveControlPoint (_indx, _newX, _newY, _newZ) { throw new Error('Composite::addControlPoint() must be overriden') }
  ...
  getZ (_t) { throw new Error('Composite::getZ() must be overriden') }
}
